      ...
      <div className="flex max-h-[88vh] w-full max-w-2xl flex-col overflow-hidden rounded-xl bg-white shadow-[0_24px_64px_rgba(0,0,0,0.18)]">
        ...
        <div className="flex items-center justify-between border-b border-black/[0.06] px-5 py-4">
          <div className="flex items-center gap-2">
            ...
            <p className="text-[0.95rem] font-extrabold text-[#1a1a1a]">Editing products by CSV: read this before you export</p>
          </div>
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 py-4 text-[0.85rem] leading-relaxed text-[#1a1a1a]">
          ...
          <ol className="mb-5 list-decimal space-y-2 pl-5">
            <li><strong>Export.</strong> Pick a brand in the dropdown, MICHELIN for example, then Export CSV. The file holds only that brand&apos;s rows.</li>
          ...
          <div className="mb-5 overflow-x-auto rounded-lg ring-1 ring-black/[0.06]">
            <table className="w-full min-w-[520px] text-left text-[0.8rem]">
              ...
              <tbody className="divide-y divide-black/[0.04]">
                ...
                <tr><td className="px-3 py-2 font-mono">description</td><td className="px-3 py-2">The field this whole loop exists for. Plain text; the rich HTML descriptions on product pages live elsewhere and are safe.</td></tr>
                <tr><td className="px-3 py-2 font-mono">name</td><td className="px-3 py-2">Exported as &ldquo;BRAND Name&rdquo;. The import strips the brand prefix back off, so keep that format if you edit it.</td></tr>
                ...
                <tr><td className="px-3 py-2 font-mono">cost</td><td className="px-3 py-2">The Tyre100 supplier price. It feeds the pricing formula, so change it only deliberately.</td></tr>
          ...
          <div className="mb-4 flex items-start gap-2.5 rounded-lg border border-emerald-200 bg-emerald-50 px-3.5 py-3 text-[0.8rem] text-emerald-800">
            ...
            <span>
              Import can never break: <strong>images, product URLs, eBay listing state, rich HTML descriptions, spec sheets</strong>. None of these
